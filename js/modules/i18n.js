...
const STRINGS = {
  he: {
    ...
    legendExtra: 'לא ציפינו - עלה', legendPending: 'צפוי לעלות, טרם נבדק', legendNo: 'לא ברשימת ההסעה', campCellHint: 'הקש כדי לעבור בין המצבים', legendEmpty: 'טרם סומן', legendCampOk: 'הגיע, כמצופה', legendCampNo: 'לא מצופה', legendCampExtra: 'הגיע ללא ציפייה', legendCampMiss: 'צפוי היה ולא הגיע', installApp: 'התקן אפליקציה',
    ...
    copyLink: 'העתק קישור', shareLink: 'שתף', renamePlayer: 'שינוי שם שחקן', rename: 'שנה שם', errDuplicatePlayer: 'שם זה כבר קיים ברשימה.',
  ...
  en: {
    ...
    legendExtra: 'Unexpected - rode', legendPending: 'Expected to ride, not yet checked', legendNo: 'Not on bus list', campCellHint: 'Tap to cycle through states', legendEmpty: 'Not marked yet', legendCampOk: 'Came, as expected', legendCampNo: 'Not expected', legendCampExtra: 'Came, unexpectedly', legendCampMiss: 'Expected, but missed', installApp: 'Install App',
    ...
    copyLink: 'Copy Link', shareLink: 'Share', renamePlayer: 'Rename Player', rename: 'Rename', errDuplicatePlayer: 'This name is already in the list.',
